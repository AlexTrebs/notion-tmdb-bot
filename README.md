...
NOTION_DATABASE_ID=25ee7153-f4b9-80b2-9dfd-cea91237d4b1
NOTION_TITLE_PROP=Movie / Series
...
```python
PROP_HANDLERS["Revenue"] = lambda info: {"number": info.get("revenue")}
```
